...
{ value: "Box singolo", label: "Box singolo" },
{ value: "Box doppio", label: "Box doppio" },
{ value: "Posto auto", label: "Posto auto" },
{ value: "CapannoniLocArtigianali", label: "Capannoni, Loc. Artigianali" },
{ value: "Capannone artigianale", label: "Capannone artigianale" },
{ value: "Capannone industriale", label: "Capannone industriale" },
...
{ value: "Edificabile", label: "Edificabile" },
{ value: "Agricolo", label: "Agricolo" },
{ value: "Non Edificabile", label: "Non Edificabile" },
{ value: "VilleCaseIndipendenti", label: "Ville e Case Indipendenti" },
{ value: "Villa Unifamiliare", label: "Villa Unifamiliare" },
{ value: "Villa Bifamiliare", label: "Villa Bifamiliare" },
{ value: "Villa Plurifamiliare", label: "Villa Plurifamiliare" },
{ value: "Villa a Schiera", label: "Villa a Schiera" }
      ]
    };
  },
  methods: {
