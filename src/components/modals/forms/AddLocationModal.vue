            ...
            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_location_scroll" data-kt-scroll="true"
              ...
              <div class="d-flex flex-column mb-5 fv-row">
                ...
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox" v-model="formData.isActive" id="locationActive">
...
import { createLocation, type LocationCreateModel } from "@/core/data/locations";
...
export default defineComponent({
  ...
  setup(_, { emit }) {
    ...
    const formData = ref<LocationCreateModel>({
      name: "",
      city: "",
      isActive: true,
      orderIndex: 0,
