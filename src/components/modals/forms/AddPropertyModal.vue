    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_add_property_header">
          ...
          <!--begin::Close-->
          <div id="kt_modal_add_property_close" data-bs-dismiss="modal"
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_property_scroll" data-kt-scroll="true"
              ...
              <div class="fw-bold fs-3 rotate collapsible mb-7" data-bs-toggle="collapse"
                href="#kt_modal_add_property_billing_info" role="button" aria-expanded="false"
              ...
              <div id="kt_modal_add_property_billing_info" class="collapse show">
                ...
                <div class="d-flex flex-column mb-7 fv-row">
                  ...
                  <select class="form-control" v-model="formData.Category">
                    ...
                    <option value="Commerciale">Negozi/Locale Commerciale</option>
              ...
              <!--begin::Billing toggle-->
              <div class="fw-bold fs-3 rotate collapsible mb-7" data-bs-toggle="collapse"
                href="#kt_modal_add_property_billing_info2" role="button" aria-expanded="false"
                aria-controls="kt_property_view_details">
                Localita
                <span class="ms-2 rotate-180">
                  <KTIcon icon-name="down" icon-class="fs-3" />
              ...
              <div class="fw-bold fs-3 rotate collapsible mb-7" data-bs-toggle="collapse"
                href="#kt_modal_add_property_billing_info3" role="button" aria-expanded="true"
              ...
              <div id="kt_modal_add_property_billing_info3" class="collapse show">
                ...
                <div class="col-md-6 fv-row">
                  <!--begin::Label-->
                  <label class="fs-6 fw-semobold mb-2">Spese condominiali</label>
                  <!--end::Label-->
                  <!--begin::Input-->
                ...
                <div class="row g-9 mb-7">
                  ...
                  <div class="d-flex flex-column mb-7 fv-row">
                    <!--begin::Label-->
                    <label class="required fs-6 fw-semobold mb-2">Superficie commerciale (m²)</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                ...
                <div class="col-md-6 fv-row">
                  <!--begin::Label-->
                  <label class="fs-6 fw-semobold mb-2">Piano </label>
                  <!--end::Label-->
                  <!--begin::Input-->
                ...
                <div class="col-md-6 fv-row">
                  <!--begin::Label-->
                  <label class="required fs-6 fw-semobold mb-2">Totale piani edificio</label>
                  <!--end::Label-->
                  <!--begin::Input-->
                ...
                <div class="col-md-6 fv-row">
                  <!--begin::Label-->
                  <label class="fs-6 fw-semobold mb-2">Ascensori</label>
                  <!--end::Label-->
                  <!--begin::Input-->
                ...
                <div class="col-md-6 fv-row">
                  <!--begin::Label-->
                  <label class="fs-6 fw-semobold mb-2">Altri dettagli</label>
                  <!--end::Label-->
                  <!--begin::Input-->
                ...
                <div class="row g-9 mb-7">
                  ...
                  <div class="col-md-6 fv-row">
                    <!--begin::Label-->
                    <label class="fs-6 fw-semobold mb-2">Camere da letto</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                ...
                <div class="col-md-6 fv-row">
                  <!--begin::Label-->
                  <label class="fs-6 fw-semobold mb-2">Locali</label>
                  <!--end::Label-->
                  <!--begin::Input-->
                ...
                <div class="row g-9 mb-7">
                  ...
                  <div class="col-md-6 fv-row">
                    <!--begin::Label-->
                    <label class="fs-6 fw-semobold mb-2">Cucine</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                ...
                <div class="col-md-6 fv-row">
                  <!--begin::Label-->
                  <label class="fs-6 fw-semobold mb-2">Bagni</label>
                  <!--end::Label-->
                  <!--begin::Input-->
                ...
                <div class="col-md-6 fv-row">
                  <!--begin::Label-->
                  <label class="fs-6 fw-semobold mb-2">Posti Auto</label>
                  <!--end::Label-->
                  <!--begin::Input-->
                ...
                <div class="col-md-6 fv-row">
                  <!--begin::Label-->
                  <label class="fs-6 fw-semobold mb-2">Anno di costruzione</label>
                  <!--end::Label-->
                  <!--begin::Input-->
                ...
                <div class="d-flex flex-column mb-2 fv-row">
                  <!--begin::Label-->
                  <label class="required fs-6 fw-semobold mb-2">Url Video</label>
                  <!--end::Label-->
                  <!--begin::Input-->
                  <el-form-item prop="VideoUrl">
                    <el-input v-model="formData.VideoUrl" type="text" />
                  </el-form-item>
                  <!--end::Input-->
                </div>
                <!--end::Input group-->
            ...
            <div class="modal-footer flex-center">
              <!--begin::Button-->
              <button type="reset" id="kt_modal_add_property_cancel" class="btn btn-light me-3">
                Scarta
              </button>
              <!--end::Button-->
...
export default defineComponent({
  ...
  setup(_, { emit }) {
    ...
    const tipologiePerCategoria = {
          ...
          Commerciale :["Locale commerciale", "Negozio", "Ufficio"],
