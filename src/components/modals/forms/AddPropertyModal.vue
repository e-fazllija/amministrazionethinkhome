                  ...
                  <label class="fs-6 fw-semobold mb-2">
                       <span class="required">Categoria</span>
                             <i
                               ...
                               title="Seleziona una categoria di immobile"
                             ></i>
                    </label>
                  <!--end::Label-->
                  <!--begin::Input-->
                  <el-select v-model="formData.categoria">
                  <el-option value="">Seleziona una Categoria...</el-option>
                  <el-option value="Residenziale">Residenziale</el-option>
                  <el-option value="Capannone">Capannone</el-option>
                  <el-option value="Negozi-Locale Commerciale">Negozi/Locale Commerciale</el-option>
                  <el-option value="Magazzino">Magazzino</el-option>
                  <el-option value="Garage">Garage</el-option>
                  <el-option value="Ufficio">Ufficio</el-option>
                  <el-option value="Terreno">Terreno</el-option>
                  </el-select>
                  <!--end::Input-->
              </div>
              <!--end::Input group-->
